...
class Interceptor extends \Magento\Widget\Controller\Adminhtml\Widget\BuildWidget implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\Widget\Model\Widget $widget, ?\Magento\Framework\Serialize\SerializerInterface $serializer = null)
    {
        $this->___init();
        parent::__construct($context, $widget, $serializer);
    }
