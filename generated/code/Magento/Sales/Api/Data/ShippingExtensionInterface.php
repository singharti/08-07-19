...
interface ShippingExtensionInterface extends \Magento\Framework\Api\ExtensionAttributesInterface
{
    ...
    /**
     * @return \Temando\Shipping\Api\Data\CollectionPoint\OrderCollectionPointInterface|null
     */
    public function getCollectionPoint();

    /**
     * @param \Temando\Shipping\Api\Data\CollectionPoint\OrderCollectionPointInterface $collectionPoint
     * @return $this
     */
    public function setCollectionPoint(\Temando\Shipping\Api\Data\CollectionPoint\OrderCollectionPointInterface $collectionPoint);
}
